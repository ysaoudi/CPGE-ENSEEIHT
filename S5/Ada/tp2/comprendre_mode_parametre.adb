...
procedure Comprendre_Mode_Parametre is
    ...
    begin
        ...
        Incrementer (A);
        Incrementer (10); --A est une constante et non une variable!
        Incrementer (10 * A);
        Incrementer (B);

        Mettre_A_Zero (A);
        Mettre_A_Zero (10); --A est une constante et non une variable!
        Mettre_A_Zero (10 * A); --A est une constante et non une variable!
        Mettre_A_Zero (B);
    ...
    begin
        ...
        L := A;
        A := 1; --A est une variable en mode in et ne peut être modifiée
