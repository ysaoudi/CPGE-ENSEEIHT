...
# Spécification du module ensemble (5 pt) : 2
...
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+
| Erreur sur précondition   | .5  |     |     |     |  X  |     |     ||     |     |     |     |     |     |
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+
| Erreur sur postcondition  | .5  |     |     |     |  X  |     |   X ||     |  X  |     |  X  |     |  X  |
+---------------------------+-----+-----+-----+-----+-----+-----+-----++-----+-----+-----+-----+-----+-----+

1 point de pénalité pour chacun des points suivants non respectés :


.5 point de pénalité pour chacun des points suivants :


# Implantation du module ensemble (7 pt) : 6,5
...
Les contraintes suivantes n'ont pas été respectées (1 pt de pénalité) :


Les maladresses suivantes ont été constatées (.5 pt dans le tableau précédent) :


# Les programmes (5 pt) : 4,5
