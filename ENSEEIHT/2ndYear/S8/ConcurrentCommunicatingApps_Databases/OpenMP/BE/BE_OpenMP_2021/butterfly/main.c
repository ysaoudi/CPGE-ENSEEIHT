 ...
 * * Execution Time : (for l = 4)
 *  1 Thread:  0.40 ms (par)
 *  2 Threads: 1.79 ms (par)
 *  4 Threads: 7.21 ms (par)
 * 
 * Execution Time : (for l = 8)
 *  1 Thread:  102.59 ms (par)
 *  2 Threads: 53.47 ms (par)
 *  4 Threads: 38.6 ms (par)
 * 
 * The achieved speedup is reasonable when considering an important value of l
 * with an appropriate of threads.
 **/