...
public class VersionSynchronized {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfThreads; i++) {
            allThreads[i] = new Thread(new VersionSynchronizedProcesses(), String.valueOf(i));
            allThreads[i].start();
        }
...
class VersionSynchronizedProcesses implements Runnable {
