...
class TamponBorné {
    ...
    public void déposer() { // pour le test, les valeurs déposées sont prédéfinies
        ...
        /**
         * A compléter : attendre que le dépôt soit possible. Pour une attente
         * bloquante, il suffit que le thread courant appelle wait() (ou this.wait())
         * (c.-à-d. qu'on peut utiliser le verrou associé au TamponBorné sur lequel on
         * appelle déposer() )
         *
         *
         *
        ...
        synchronized (this) {
            ...
            /**
             * A compléter : réveiller (notify()) un éventuel thread en attente d'accès au
             * TamponBorné
             *
             *
             **/
