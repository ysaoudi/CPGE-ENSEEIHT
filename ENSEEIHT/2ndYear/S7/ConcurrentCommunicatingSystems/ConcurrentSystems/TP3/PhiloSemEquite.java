...
public class PhiloSemEquite implements StrategiePhilo {
    ...
    public String nom() {
    	return "Implantation Sémaphores, stratégie \"Etats des Philosophes avec Equite\"";
    }
}
